    ...
    <script type="text/javascript">
        ...
        $(function ()
        {
            ...
            gridMain = $("#maingrid").ligerGrid({
                columns: 
                    [
                    { display:'资源项名称', name:'resName', width:180, align:'left' },
                    { display:'资源项编码', name:'resCode', width:200, align:'left' },
                    { display:'资源项说明', name:'description', width:180, align:'left' }
               		],  
        ...
        {
        	var url = timeURL('${ctx}/system/res/item/move.do?moveId=${item.resId}&targetId='+targetId+'&moveType='+moveType);
        	$.ajax({
        		url: url,
        		dataType: 'json',
