...
<body> 
	<form:form id="formSave" modelAttribute="menu" action="${ctx}/system/privilege/group/save.do" method="post">
		...
		<table align="center" class="tb_edit Tab_box">
            ...
            <tr>
                <td align="right" ><span class="T_title">权限组名称:</span></td>
                <td><input id="name" name="name" value="${group.name}" type="text" ltype="text" class="validate[required,maxSize[64]] content3" /></td>
                <td></td>
                <td align="right"><span class="T_title">权限组状态:</span></td>
                <td><s:resSelect name="status" value="${group.status}" code="privGrpStatus" ltype="select" /></td>
                <td></td>
            </tr>
            <tr>
                <td align="right"><span class="T_title">权限组说明:</span></td>
                <td colspan=4><input id="remark" name="remark" value="${group.remark}" type="text" ltype="text" class="validate[optional,maxSize[128]] content3"  /></td>
                <td></td>
            </tr>
            <tr>
