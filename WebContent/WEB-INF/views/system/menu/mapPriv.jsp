...
<script type="text/javascript">
    ...
    $(function ()
    {
        ...
        gridMain = $("#maingrid").ligerGrid({
            columns: 
                [
                 { display:'权限组', name:'name', width:150, align:'left' },
...
<body style="padding:0; overflow:hidden; position:relative;"> 
  <form style="padding:0px;" id="mapForm" action="${ctx}/system/menu/mapPriv.do" method="post">
  <input type="hidden" name="menuId" value="${menu.id}"/>
  <div style="width:100%; padding:5px; overflow:hidden; ">
    <table>
      <tr>
        <td>当前菜单"${menu.name}" 关联权限设置</td>
        <td width="10"></td>
        <td> <input type="checkbox" onclick="chkAll(this)"/>全选</td>
        <td width="10"></td>
        <td><input id="bnSearch" type="submit" value="确 定" class="l-button bn2"/></td>
      </tr>
    </table>
  </div>    
  <div id="maingrid"></div> 
