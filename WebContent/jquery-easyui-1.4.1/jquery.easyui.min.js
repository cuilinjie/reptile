...
$.ajax({type:opts.method,url:opts.url,cache:false,data:_1bb,dataType:"json",success:function(data){
_1bc(data);
},error:function(){
...
$.ajax({url:data,data:_4c1,cache:false,dataType:"json",success:function(data){
_4c2(data);
},error:function(){
...
opts.finder.getTr(_640,"","selected",2).each(function(){
	//2014.12.22 添加selected方法rowIndex 属性
	var row = opts.finder.getRow(_640,$(this));
	if(_641.selectedRows && _641.selectedRows.length > 0){
		for(var r in _641.selectedRows){
			if(row[opts.idField] == _641.selectedRows[r][opts.idField]){
				_641.selectedRows[r]['rowIndex'] = this.rowIndex;
			}
		}
	}
});
...
$.ajax({type:opts.method,cache:false,url:opts.url,data:_76c,dataType:"json",success:function(data){
_76d(data);
},error:function(){
...
$.ajax({type:opts.method,cache:false,url:opts.url,data:_8c8,dataType:"json",success:function(data){
_8c9(data);
},error:function(){
...
$.ajax({type:opts.method,cache:false,url:opts.url,data:_95e,dataType:"json",success:function(data){
_95f(data);
},error:function(){
